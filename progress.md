...
| Blog pages HTML update | Done | Blog listing + 5 article pages rebuilt with v2 redesign navbar, mobile menu, footer, AOS, section labels, scroll-to-top, mobile call button. Service-specific footer emails (tiling→northshoretiling8, painting→northshorepainting88, cleaning→northshorecleans8). Blog listing cards fixed to point to correct files. |
